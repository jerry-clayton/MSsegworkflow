...
#     mergedLAS <- mergeBelowThreshold(f_head, f_las, 7)
#     mergedLAS <- mergeAboveThreshold(f_head, mergedLAS, 7)
#
#     condition_descriptor <- 'above_below_7'
#     outfile <- paste0('../merged_las_outs/above_below/',plot,condition_descriptor,'merged.las')
